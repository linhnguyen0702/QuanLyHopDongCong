...
import { FileText, Building2, DollarSign, TrendingUp, Clock, CheckCircle, AlertTriangle, Plus } from "lucide-react"
        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-2">Theo dõi và quản lý các hợp đồng dự án nhà nước</p>
            </div>
            <Button className="bg-secondary hover:bg-secondary/90" onClick={handleCreateContract}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            >
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Nhà thầu</CardTitle>
            ...
            <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => router.push("/reports")}>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Giá trị hợp đồng</CardTitle>
            ...
            <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => router.push("/reports")}>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Tỷ lệ hoàn thành đúng hạn</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>Danh sách các hợp đồng được tạo và cập nhật gần đây</CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-yellow-800">3 hợp đồng sắp hết hạn</p>
                      <p className="text-xs text-yellow-600">Cần gia hạn trong 7 ngày tới</p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-red-800">2 thanh toán quá hạn</p>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-green-800">Blockchain đồng bộ</p>
                      <p className="text-xs text-green-600">Tất cả giao dịch đã được xác thực</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
