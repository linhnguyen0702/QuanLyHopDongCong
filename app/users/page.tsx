    ...
    if (!loading) {
      ...
      if (user.role !== "admin") {
        ...
        toast({
          ...
          description: `Bạn không có quyền truy cập trang này. Quyền hiện tại: ${user.role}, cần quyền admin.`,
          variant: "destructive",
        });
        router.push("/");
        return;
  ...
  const handleDeactivate = async (userId: number) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        toast({
          title: "Lỗi",
          description: response.message || "Không thể vô hiệu hóa người dùng",
          variant: "destructive",
        });
      }
    } catch (error) {
