          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Phân tích hiệu suất và xu hướng hợp đồng
              </p>
            </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      <span className="text-green-600">+12%</span> so với kỳ
                      trước
                    </p>
                  </CardContent>
                </Card>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Số lượng và giá trị hợp đồng 6 tháng gần đây
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Tỷ lệ hợp đồng theo từng trạng thái
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
            ...
            <TabsContent value="contracts" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Thống kê hợp đồng theo từng lĩnh vực
                  </CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      >
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-3 gap-4 text-sm text-muted-foreground">
                            ...
                            <div>
                              <span className="font-medium">
                                {category.value}B VNĐ
                              </span>{" "}
                              giá trị
                            </div>
                            <div>
                              <TrendingUp className="h-4 w-4 inline mr-1" />
                              {category.growth > 0 ? "Tăng" : "Giảm"}{" "}
            ...
            <TabsContent value="contractors" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Xếp hạng nhà thầu theo hiệu suất và giá trị hợp đồng
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                      ...
                      >
                        ...
                        <div className="text-right">
                          <div className="text-sm font-medium">
                            {contractor.completion}% hoàn thành
                          </div>
                          <Progress
            ...
            <TabsContent value="performance" className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Theo dõi hiệu suất thực hiện hợp đồng theo thời gian
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={400}>
