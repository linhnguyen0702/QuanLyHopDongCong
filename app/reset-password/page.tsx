...
export default function ResetPasswordPage() {
  ...
  const passwordRequirements = [
    ...
    { text: "Có chữ hoa và chữ thường", met: /[a-z]/.test(password) && /[A-Z]/.test(password) },
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-border/50 shadow-xl">
            <CardHeader className="space-y-1 text-center">
              ...
              <CardTitle className="text-2xl font-bold">Đặt lại thành công!</CardTitle>
              <CardDescription>Mật khẩu của bạn đã được cập nhật thành công</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-muted/50 rounded-lg p-4 text-center">
                <p className="text-sm text-muted-foreground mb-2">Bạn có thể đăng nhập với mật khẩu mới</p>
              </div>
