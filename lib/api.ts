...
export const authApi = {
  ...
  updateProfile: (data: { fullName: string; company: string }) => apiClient.put("/auth/profile", data),
...
export const contractsApi = {
  getAll: (params?: PaginationParams & { status?: string; contractorId?: number }) =>
...
export const contractorsApi = {
  getAll: (params?: PaginationParams & { status?: string }) => apiClient.get("/contractors", params),
  ...
  getPerformance: (id: number) => apiClient.get(`/contractors/${id}/performance`),
}

// Users API
export const usersApi = {
  getAll: (params?: PaginationParams & { role?: string }) => apiClient.get("/users", params),
  ...
  getActivity: (id: number, params?: PaginationParams) => apiClient.get(`/users/${id}/activity`, params),
